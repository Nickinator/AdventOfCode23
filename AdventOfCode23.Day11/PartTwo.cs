...
static class SolutionDay11Part02
{
    ...
    class Universe
    {
        ...
        const int EXPANSION_FACTOR = 1_000_000;
        const int LINEAR_OFFSET = EXPANSION_FACTOR - 1;
        ...
        public IEnumerable<long> ShortestPaths()
        {
            ...
            for (int i = 0; i < galaxies.Count() - 1; i++)
            {
                ...
                {
                    yield return galaxies
                        .ElementAt(i)
                        .Distance(galaxies.ElementAt(j));
                }
            }
        }
    }
